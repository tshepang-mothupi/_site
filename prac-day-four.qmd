...
paste0("Proportion flights delayed but on arrival on time out of the total delayed flights: ", 100*round(delayed_arrival_timely/total_delayed,4),"%")
paste0("Proportion flights delayed but on arrival on time out of the all the flights: ", 100*round(delayed_arrival_timely/total_flight,4),"%")
